...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('help')
        .setDescription('Displays the command list and my information'),
    ...
    async execute(interaction) {
        ...
        if (interaction.isCommand && interaction.isCommand()) {
            ...
            const BOT_ICON = "https://cdn.discordapp.com/icons/1095541202683707394/4ead1273e71a8d4d66ccaeba09b4a907.webp";
            const EMBED_COLOR = "#5865F2"; 
            const FOOTER_TEXT = "Smol Katheryne | Powered by Hakoo";
            ...
            const createPages = (commandSet, type) => {
                ...
                pages.push({
                    title: '✨ Smol Katheryne',
                    description: [
                        '### THE DISCORD OPERATING SYSTEM',
                        '',
                        '> The ultimate Katheryne for all your server needs',
                        '',
                        '**STATISTICS**',
                        `\`🧠\` **Version:** 1.2.2`,
                    ...
                    author: { name: 'SMOL KATHERYNE • COMMAND CENTER' },
                    icon: '📚'
                });
            ...
            const embed = new EmbedBuilder()
                ...
                .setFooter({ text: 'Smol Katheryne • Error' })
                .setTimestamp();
