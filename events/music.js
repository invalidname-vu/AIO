        ...
        client.riffy.on('trackStart', async (player, track) => {
            ...
            try {
                ...
                const cardImage = await dynamicCard({
                    ...
                    trackRequester: track.requester ? track.requester.username : "Smol Katheryne",
                ...
                const embed = new EmbedBuilder()
                    .setAuthor({ name: "Now Playing..", iconURL: musicIcons.playerIcon, url: "https://discord.gg/k8FkPyA3ST" })
